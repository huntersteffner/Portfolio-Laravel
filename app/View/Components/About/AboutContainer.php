...
class AboutContainer extends Component
{
    public $paragraphs = array(
        ...
        Customer Service Representative for digital banking applications. My company\'s proprietary software fascinated me, and I wanted to know how it functioned behind the scenes. So I started studying how computers and the web work in my spare time. As I began to understand the fundamentals of programming, I really found my niche exploring Web Development with HTML, CSS, and JavaScript.',
        'After 4.5 years at NCR, I decided to make a career
        change and enrolled in a Full-Stack Coding Bootcamp at Georgia Tech. After completing this course, I worked for a few months as a Teaching Assistant at a Coding Bootcamp very similar to the one I had previously studied under. In March 2023, I accepted an offer for a full-time position at Electrolux as an E-Commerce Web Developer.',
