<section>
    <div class="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
        ...
        <div class="mt-4 md:mt-0">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Ready to get started</h2>
            <p class="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">I am always looking for freelancing opportunities. If you are looking for a web based solution, look no further. Let's connect!</p>
